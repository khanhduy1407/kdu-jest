...
const replace = (oldThing, newThing) => {
  ...
  logger.warn(chalk.yellow('This option will be removed in the next major version of `kdu-jest`. Please update your configuration.'), '\n')
  logger.warn(chalk.bold.yellow('Configuration Documentation:'))
  logger.warn(chalk.yellow('https://github.com/khanhduy1407/kdu-jest'))
}
