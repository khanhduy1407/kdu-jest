...
module.exports = function compileBabel (scriptContent, inputSourceMap, inlineConfig, kduJestConfig, filePath) {
  const babelConfig = inlineConfig || loadBabelConfig(kduJestConfig, filePath)
